...
namespace BoidCharacter
{
    ...
    [RequireComponent(typeof(BoidCharacter))]
    public class BoidCharacterRenderer : MonoBehaviour
    {
        #region Paremeters
        ...
        // GPUBoidsスクリプトの参照
        public BoidCharacter GPUBoidsScript;
        #endregion
        ...
        void Start()
        {
            ...
            boidscript = GetComponent<BoidCharacter>();
        }

        void Update()
        {
            //if (Vector3.Distance(boidscript.Hands.pos[0], boidscript.Hands.pos[1])>10) {
            // メッシュをインスタンシング
            RenderInstancedMesh();
            //}
